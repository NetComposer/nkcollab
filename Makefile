...
shell:
	erl -config util/shell_app.config -args_file util/shell_vm.args -s nkcollab_app $(RELOADER)

sample:
	erl -config util/shell_app.config -args_file util/shell_vm.args -s nkcollab_app -s nkcollab_sample $(RELOADER)
...
dialyzer:
	dialyzer -Wno_return --plt $(COMBO_PLT) ebin/nkcollab*.beam #| \
